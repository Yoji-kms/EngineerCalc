...
public class MainActivity extends AppCompatActivity {
    ...
    private final CompoundButton.OnCheckedChangeListener showEngFunSwOnCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        engLayout = findViewById(R.id.engineerLayoutId);
    }
    ...
    public void init() {
        ...
        //Switch
        Switch showEngFunSw = findViewById(R.id.showEngFunSwId);
        ...
        //Switch Listener
        showEngFunSw.setOnCheckedChangeListener(showEngFunSwOnCheckedChangeListener);
